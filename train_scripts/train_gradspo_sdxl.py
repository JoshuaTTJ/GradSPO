...
config_flags.DEFINE_config_file(
    "config", 
    "configs/gradspo_sdxl_4k-prompts_num-sam-2_3-is_10ep_bs2_gradacc2.py", 
                ...
                with accelerator.accumulate(unet):
                    with autocast():
                        if config.train.cfg:
                            ...
                            noise_ema_pred_1 = noise_ema_pred_0.clone()
                    ...
                    loss_0 = score_matching_loss(
                        ...
                        noise_pred_0,
                        sample_0["timesteps"][train_b_start: train_b_end],
                        noise_added=sample_0["noise_added"][train_b_start: train_b_end],
                    ...
                    loss_1 = score_matching_loss(
                        ...
                        noise_pred_1,
                        sample_1["timesteps"][train_b_start: train_b_end],
                        noise_added=sample_1["noise_added"][train_b_start: train_b_end],
